...
#
# This script downloads ERA5 data from the WeatherBench2 Google Cloud Storage bucket.
#
# Requirements:
...
# Configuration
DATASET="era5/1959-2023_01_10-6h-240x121_equiangular_with_poles_conservative.zarr"
SURFACE_VARIABLES=(2m_temperature 2m_dewpoint_temperature sea_surface_temperature 10m_u_component_of_wind 10m_v_component_of_wind mean_sea_level_pressure total_precipitation_6hr total_column_water_vapour )
