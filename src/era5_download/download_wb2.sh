VARIABLES=(latitude longitude time level 2m_temperature 10m_u_component_of_wind 10m_v_component_of_wind mean_sea_level_pressure total_precipitation_6hr geopotential u_component_of_wind v_component_of_wind temperature relative_humidity specific_humidity land_sea_mask soil_type geopotential_at_surface)
