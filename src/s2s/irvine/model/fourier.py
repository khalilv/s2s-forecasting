...
from s2s.irvine.model.area import area, radius_earth
...
relative_time_expansion = FourierExpansion(1, 24 * 365.25)
""":class:`.FourierExpansion`: Fourier expansion for relative timestamps in hours."""